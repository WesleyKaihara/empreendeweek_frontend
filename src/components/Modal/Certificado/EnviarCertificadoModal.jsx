...
const EnviarCertificadoModal = () => {
  ...
  return (
    <div className="modal fade" id="enviarCertificadoModal" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="certificadosModalLabel" aria-hidden="true">
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="certificadosModalLabel">Envio de Certificados</h5>
